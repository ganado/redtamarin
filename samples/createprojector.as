...
Usage:
 ...
 -o filename    defines the name of the output file
    ...
    if( output_name == "" )
    {
	    ...
	    if( s.match(/\.abc$/))
	    {
	        output_name = s.replace(/\.abc$/, ".exe");
	    }
	    else if( s.match(/\.swf$/))
	    {
	        output_name = s.replace(/\.swf$/, ".exe");
	    }
	    else
	    {
	        output_name = s + ".exe";
    ...
    var exe_in:ByteArray = File.readByteArray( avmshell_exe );

    var file_in:ByteArray = File.readByteArray( input_name );
    ...
    */
    ...
    var written:Boolean = File.writeByteArray( output_name, exe_out );
